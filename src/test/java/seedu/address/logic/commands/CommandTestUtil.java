...
public class CommandTestUtil {
    ...
    public static final String VALID_APPOINTMENT_INPUT_BOB = "2025-10-10";
    public static final String VALID_APPOINTMENT_TIME_INPUT_BOB = "05:30";
    public static final String VALID_APPOINTMENT_CALMEN = "No Appointment Scheduled Yet";
    public static final String VALID_APPOINTMENT_TIME_CALMEN = "";
    public static final String VALID_APPOINTMENT_VENUE_CALMEN = "";
    public static final String VALID_APPOINTMENT_DERRICK = "No Appointment Scheduled Yet";
    public static final String VALID_APPOINTMENT_TIME_DERRICK = "";
    public static final String VALID_APPOINTMENT_VENUE_DERRICK = "";
