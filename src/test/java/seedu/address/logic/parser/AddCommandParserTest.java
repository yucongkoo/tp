...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_DERRICK + PHONE_DESC_DERRICK
                + EMAIL_DESC_DERRICK + ADDRESS_DESC_DERRICK + TAG_DESC_FRIEND + PRIORITY_DESC_HIGH,
        ...
        assertParseSuccess(parser,
                NAME_DESC_DERRICK + PHONE_DESC_DERRICK + EMAIL_DESC_DERRICK + ADDRESS_DESC_DERRICK
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + PRIORITY_DESC_HIGH,
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + PRIORITY_DESC_HIGH;
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, NonEmptyAddress.MESSAGE_CONSTRAINTS);
        ...
        // invalid priority
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_FRIEND + INVALID_PRIORITY_DESC, Priority.MESSAGE_CONSTRAINTS);

        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_FRIEND + INVALID_PRIORITY_DESC2, Priority.MESSAGE_CONSTRAINTS);
